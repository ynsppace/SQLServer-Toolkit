...
SET @condition='out.MANDT=''100'' and out.FILTP=''VMAT'' and out.DESTINY_ID=''VVP'' and out.DT_CR>=CONVERT(varchar(14), DATEADD(DAY, -1, GETDATE()), 112 )
and out.DT_CR< CONVERT(varchar(14), DATEADD(DAY, 0, GETDATE()), 112)
Group by out.FILTP, RIGHT(out.FNAM,2)
HAVING COUNT(out.FNAM) < 4'
